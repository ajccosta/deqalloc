...
#include "../threads/uepochTest.h"
#include <optional>

//Harris Linked List used for Testing
...
public:
    ...
    HarrisLinkedListTest() {
        head = new(Allocator::malloc(sizeof(Node))) Node(T{}, V{});
        tail = new(Allocator::malloc(sizeof(Node))) Node(T{}, V{});
        head->next = tail;
    }
    ...
    static std::string className() { return "HarrisLinkedListTestSet" ; }
